                ...
                <div className='grid grid-cols-1 lg:grid-cols-12 space-x-1 items-center'>
                    <div className='col-span-6 flex flex-col gap-8'>
                        ...
                        <div className='flex items-center justify-between pt-10 lg:pt-4'>
                            {['Flexible', 'Learning path', 'Community'].map((item, index) => (
                                <div className='flex gap-2' key={index}>
                                    <Image
                                        src={`${prefix}images/banner/check-circle.svg`}
                                        alt="check-image"
                                        width={30}
                                        height={30}
                                        className='smallImage'
                                    />
                                    <p className='text-sm sm:text-lg font-normal text-black'>{item}</p>
                                </div>
                            ))}
                        </div>
                    </div>
                    ...
                    <div className='col-span-6 flex justify-center'>
                        <Image
                            src={`${prefix}images/banner/mahila.png`}
                            alt="Hero banner"
                            width={1000}
                            height={805}
