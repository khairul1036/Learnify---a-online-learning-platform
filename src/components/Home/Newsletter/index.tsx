                        ...
                        <div className="mb-10 mt-24 lg:mx-64 lg:my-24">
                            ...
                            <div>
                                <div className="relative text-white focus-within:text-white flex flex-row-reverse rounded-full pt-5 lg:pt-0">
                                    <input type="Email address" name="q" className="py-6 lg:py-8 text-sm md:text-lg w-full mx-3 border shadow-2xl rounded-full pl-8 focus:outline-none " placeholder="Enter your email address" autoComplete="off" />
